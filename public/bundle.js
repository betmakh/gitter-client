...
/***/ function(module, exports, __webpack_require__) {
	...
	if (tokenEl) {
	  ...
	  //   });
	  (0, _isomorphicFetch2.default)('https://api.gitter.im/v1/user?access_token=' + tokenEl.value, {
	    headers: {
	...
	console.log('actions', _constants.actions);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keyMirror = __webpack_require__(4);
	...
	_lodash2.default.mixin({
		keyMirror: _keyMirror2.default
	});

	var actions = _lodash2.default.keyMirror({
		USER_LOGIN: null,
		USER_LOGOUT: null
	});
